...
template: splash
hero:
  tagline: "<strong>As easy as Python, as fast as C.</strong> Statically-typed scripting language with an LLVM 18 backend, batteries-included HTTP / JSON / SQLite stack, and full editor tooling out of the box."
  image:
