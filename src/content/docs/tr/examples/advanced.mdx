...
:::note
Bu örnekler tarayıcı playground'unda **paketlenmeyen** native özellikleri (TCP
soketleri, SQLite, dosya sistemi) kullanır. Kod olarak gösterilirler; Tulpar
CLI ile çalıştırın (`tulpar app.tpr`). Tarayıcıda çalışan parçacıklar için
[Temel Örnekler](/tr/examples/basic/)'e bakın.
:::
...
Daha üst seviye bir veri katmanı için [ORM](/tr/ecosystem/orm/) ve
[Wings Tarif Kitabı](/tr/ecosystem/wings-cookbook/) SQLite tarifine bakın.
