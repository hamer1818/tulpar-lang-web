...
`match` evaluates its subject once and takes the first matching arm. v1
patterns are scalar literals (int / string / bool), `|`-alternatives, and
`lo .. hi` ranges; `_` is the catch-all.
